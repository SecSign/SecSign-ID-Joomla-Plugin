...
jQuery(document).ready(function () {
    ...
    jQuery('#secsignidplugin').find(pwloginbutton).prop('disabled', true);
    ...
    jQuery('#secsignidplugin').find(pwloginuser).on('input', function () {
        if (jQuery(this).val().length > 0 && jQuery('#secsignidplugin').find(pwloginpw).val().length > 0) {
            jQuery('#secsignidplugin').find(pwloginbutton).prop('disabled', false);

        } else {
            jQuery('#secsignidplugin').find(pwloginbutton).prop('disabled', true);
        }
    });
    jQuery('#secsignidplugin').find(pwloginpw).on('input', function () {
        if (jQuery(this).val().length > 0 && jQuery('#secsignidplugin').find(pwloginuser).val().length > 0) {
            jQuery('#secsignidplugin').find(pwloginbutton).prop('disabled', false);
        } else {
            jQuery('#secsignidplugin').find(pwloginbutton).prop('disabled', true);
        }
...
function clearSecsignForm() {
    jQuery("#secsignid-accesspass-img").attr('src', secsignPluginPath + secsignPreload);
...
//Load SecSignID API
jQuery(document).ready(function () {
    jQuery.getScript(secsignPluginPath + secsignAPI, function () {
